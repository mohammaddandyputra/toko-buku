<html lang="en">
    <head>
        ...
        <title>Olshop @yield('title')</title>
    ...
    <body>
        <nav class="navbar navbar-expand p-0">
            <a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"><i><strong>E</strong></i>-Commerce </a>
            ...
            <div class="dropdown d-none d-md-block ml-5">
                @if(\Auth::user())
